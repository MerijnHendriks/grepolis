...
(function() {
	...
	Benefit._boundStartListener = function() {
		...
		if (startIn > 0) {
			...
			TM.register(this.url() + '_started', startIn, this.trigger.bind(this, 'started', this, true), {max: 1});
		}
	};
	...
	Benefit._boundEndListener = function() {
		...
		if (endIn > 0) {
			...
			TM.register(this.url() + '_ended', endIn, this.trigger.bind(this, 'ended', this, true), {max: 1});
		}
	};
