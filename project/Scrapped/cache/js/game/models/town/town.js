/*globals GrepolisModel, GameData, GameDataBuildings, Game, TownRelationProvider, TownResources, DeltaProperty, TownStorage */
...
(function() {
	 ...
	 *
	 * @param {integer} the storage level (optional, if left out current is used)
	...
	Town.getMilitia = function() {
		return this.relation_provider.militia();
	};
