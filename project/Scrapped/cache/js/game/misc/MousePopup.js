(function() {
	...
	var delay = function (callback){
		clearDelay();
		_delay_timer_id = setTimeout(callback, TOOLTIP_DELAY_MS);
	},
	clearDelay = function() {
	...
	jQuery.extend(MousePopup.prototype, {
		...
		position: function() {
			...
			return {left : Math.max(p_x, s_x), top : Math.max(p_y, s_y)};
		},
		p_x: 0,
		p_y: 0,
		/**
		...
		showDiv: function() {
			delay(function() {
				...
				styles = jQuery.extend(styles, {'opacity' : 1});
