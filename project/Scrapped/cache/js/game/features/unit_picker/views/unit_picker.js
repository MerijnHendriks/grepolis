    ...
    return BaseView.extend({
        ...
        registerUnitTooltips: function () {
            ...
            this.$el.find('.unit').each(function (idx, unit) {
                var $unit = $(unit),
                    hero = $unit.data('hero'),
                    tooltip = TooltipFactory.getUnitCard($unit.data('game_unit'), {unit_skin_class: this.settings.unit_tooltip_class});
        ...
        registerUnitPopulationTooltip: function () {
            ...
            this.$el.find('.unit_population_info').tooltip(template, {width: 300});
        },
