...
// namespaces for stuff used to manage windows
window.WindowManagerViews = {};
window.WindowManagerControllers = {};
window.WindowManagerCollections = {};
window.WindowManagerModels = {};

// this is a really "bad" namespace but I can not find a better one
// "pre-preloaded data"?
window.PreloadedData = {};

// namespace for stuff which implement the gamelogic
window.GameViews = {};
