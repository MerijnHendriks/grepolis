		...
		'l10n': {
			'COMMON': {
				...
				wnd_save_coordinates : {
					...
					fields : {
						title : {label : _('Title:'), value : _('Please enter a title.')},
						x : {label : _('X:')},
						y : {label : _('Y:')}
					},
					btn_confirm : _('Add')
				...
				simulator: {
					...
					alliance_modifier: function (modifier) {
						return s(_("Alliance reductions: Attacking allied troops generates %0 of the total battle points."), modifier);
					}
				},
				...
				'time' : {
					'day': __('day|d'), 'hour': __('hour|h'), 'minute': __('minute|min'), 'second': __('second|s')
				},
				'window_goto_page' : {
					'title': _('Go to page'),
					'page': _('Page'),
			...
			'common': {
				...
				'question_powers_extend_first_time' : function(hours, gold, readable_time) {
					return s(ngettext('For %1 gold, you can extend this power by %2 hour the first time you use it.', 'For %1 gold, you can extend this power by %2 hours the first time you use it.', hours), gold, readable_time);
				},
				'question_powers_extend_second_time' : function (hours, readable_time) {
					return s(ngettext('The second time, by %1 hour.', 'The second time, by %1 hours.', hours), readable_time);
				},
