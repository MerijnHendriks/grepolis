...
define('events/crafting/views/sub_windows/daily_rewards', function(require) {
	'use strict';

	var TooltipFactory = require('factories/tooltip_factory');
	var BaseView = window.GameViews.BaseView;

	var SubWindowEasterDailyRewardsView = BaseView.extend({
	...
	window.GameViews.SubWindowEasterDailyRewardsView = SubWindowEasterDailyRewardsView;
	return SubWindowEasterDailyRewardsView;
});
