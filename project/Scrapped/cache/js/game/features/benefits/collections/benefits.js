(function() {
	...
	Benefits.getAugmentationBonusForUnitBuildTime = function() {
		var factor = 1, benefit, benefits = this.models, i, l = benefits.length;
	...
	Benefits.getFirstSurveyBenefit = function() {
		return this.getBenefitsOfType('survey').length > 0 ? this.getBenefitsOfType('survey')[0] : null;
	};
