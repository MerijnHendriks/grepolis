...
(function() {
	...
	var ResearchOrder = GrepolisModel.extend({
		...
		research : function(callbacks) {
			this.execute('research', {id : this.getType()}, callbacks);
		},
		...
		revert : function(callbacks) {
			this.execute('revert', {id : this.getType()}, callbacks);
		},
		...
		halveResearchTime : function(callbacks) {
			this.execute('halveResearchTime', {order_id : this.getId()}, callbacks);
		},
		...
		buyInstant : function(callbacks) {
			this.execute('buyInstant', {order_id : this.getId()}, callbacks);
		},
