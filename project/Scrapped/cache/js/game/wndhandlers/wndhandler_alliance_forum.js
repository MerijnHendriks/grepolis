/* global AbstractWndHandlerEmailValidation, Forum, BBCode, Layout, GPWindowMgr */
...
(function() {
	...
	WndHandlerAllianceForum.prototype.onInit = function(title, UIopts){
		this.wnd.sendMessage('openIndex', {}, function () { Forum.displayData(); } );
	...
	WndHandlerAllianceForum.prototype.preventLosingData = function(type, fn) {
		...
		var action = this.action, textarea = $('#forum_post_textarea'), that = this;
