...
(function (controllers, collections, models, settings) {
	...
	var type = windows.WORLD_WONDERS_WELCOME;
	...
	settings[type] = function (props) {
		...
		return us.extend({
			...
			tabs: [
				...
				{type: tabs.INDEX, title: l10n.tabs[0], content_view_constructor: controllers.WorldWondersWelcomeController, hidden: true}
			],
			max_instances: 1,
			activepagenr: 0,
