...
(function(window) {
	...
	var GameDataResearches = {
		getBonusArchitecture : function() {return GameData.research_bonus.architecture_bonus;},
		getBonusBerth : function() {return GameData.research_bonus.berth;},
		getBonusBuildingCrane : function() {return GameData.research_bonus.building_crane_bonus;},
		getBonusCallOfTheCcean : function() {return GameData.research_bonus.call_of_the_ocean_bonus;},
		getBonusCartographySpeed : function() {return GameData.research_bonus.cartography_speed;},
		getBonusCatapultSpeed : function() {return GameData.research_bonus.catapult_speed;},
		getBonusColonyShipSpeed : function() {return GameData.research_bonus.colony_ship_speed;},
		getBonusConscription : function() {return GameData.research_bonus.conscription_bonus;},
		getBonusFavorLootPerUnit : function() {return GameData.research_bonus.favor_loot_per_unit;},
		getBonusFertilityImprovement : function() {return GameData.research_bonus.fertility_improvement_bonus;},
		getBonusInstructor : function() {return GameData.research_bonus.instructor_bonus;},
		getBonusMathematics : function() {return GameData.research_bonus.mathematics_bonus;},
		getBonusMeteorologySpeed : function() {return GameData.research_bonus.meteorology_speed;},
		getBonusPotteryStorage : function() {return GameData.research_bonus.pottery_storage;},
		getBonusShipwright : function() {return GameData.research_bonus.shipwright_bonus;},
		getBonusDiplomacyResources : function() {return GameData.research_bonus.diplomacy_resources_bonus;},
