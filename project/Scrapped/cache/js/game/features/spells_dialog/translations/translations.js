	...
	DM.loadData({
		l10n: {
			...
			premium : {
				...
				confirmation_cast_cap_of_invisibility: {
					confirmation : {
						window_title : _("Cast helmet of invisibility"),
						question : _("Your troops have travelled too far already.<br>They can't be affected by this spell anymore.<br>Are you sure you want to cast this spell?")
					}
				}
			}
		}
