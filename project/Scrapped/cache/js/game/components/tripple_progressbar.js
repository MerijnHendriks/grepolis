...
(function($) {
	...
	$.fn.progressbar = function(params) {
		...
		function showProgress(value, value2, value3) {
			if (value === null) {value = settings.value;}
			if (value2 === null) {value2 = settings.value2;}
			if (value3 === null) {value3 = settings.value3;}
			...
			var max = settings.max,
				w1 = (value / max) * width, w2 = (value2 / max) * width,
				w3 = (value3 / max) * width, start = 0,
