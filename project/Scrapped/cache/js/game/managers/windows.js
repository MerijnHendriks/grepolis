/*global jQuery, Backbone, us, CM, GPWindowMgr, MM, GameData, CloseWindowManager, FocusWindowManager */
	...
	window.WindowsManager = function() {
		...
		PrivateModule = {
			...
			closeAllWindows : function() {
				var windows = open_windows.models, l = windows.length,
		...
		Module = {
			...
			getWindowByType : function(type) {
				return open_windows.where({window_type : type});
			},
			...
			closeWindowsByType : function(type) {
				var opened_windows = this.getWindowByType(type), i, l = opened_windows.length;
			...
			minimizeAllWindows : function(force_close) {
				...
				//Handle old windows
				var open_legacy_windows = GPWindowMgr.getAllOpen(), i, l = open_legacy_windows.length, wnd;
		...
		return $.extend({
            ...
            _addFakedMinimizedWindowsForAutomationTests : function() {
                windows_view.MinimizedWndManager.collection.add([
                    {wnd_cid : 1000, title : 'title 1', type : 'old'},
                    {wnd_cid : 1001, title : 'title 2', type : 'old'},
                    {wnd_cid : 1002, title : 'title 3', type : 'old'},
                    {wnd_cid : 1003, title : 'title 4', type : 'old'},
                    {wnd_cid : 1004, title : 'title 5', type : 'old'},
                    {wnd_cid : 1005, title : 'title 6', type : 'old'},
                    {wnd_cid : 1006, title : 'title 7', type : 'old'},
                    {wnd_cid : 1007, title : 'title 8', type : 'old'},
                    {wnd_cid : 1008, title : 'title 9', type : 'old'},
                    {wnd_cid : 1009, title : 'title 10', type : 'old'},
                    {wnd_cid : 1010, title : 'title 11', type : 'old'},
                    {wnd_cid : 1011, title : 'title 12', type : 'old'},
                    {wnd_cid : 1012, title : 'title 13', type : 'old'},
                    {wnd_cid : 1013, title : 'title 14', type : 'old'},
                    {wnd_cid : 1014, title : 'title 15', type : 'old'},
                    {wnd_cid : 1015, title : 'title 16', type : 'old'},
                    {wnd_cid : 1016, title : 'title 17', type : 'old'},
                    {wnd_cid : 1017, title : 'title 18', type : 'old'},
                    {wnd_cid : 1018, title : 'title 19', type : 'old'},
                    {wnd_cid : 1019, title : 'title 20', type : 'old'}
                ]);
            }
		}, Module);
	};
