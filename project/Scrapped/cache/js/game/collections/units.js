...
(function() {
	...
	UnitsCollection.calculateTotalAmountOfUnits = function() {
		var support, supports = this.getSupportsAndUnitsInTown(), i, l = supports.length, unit_id, units, total = {};
	...
	UnitsCollection.hasNavalUnits = function() {
		var support, supports = this.getSupportsAndUnitsInTown(), i, l = supports.length, unit_id, units;
