		...
		l10n : {
			player_hints: {
				settings: {
					...
					cast_spell_confirmation: _("Cast spell confirmation prompt"),
					...
					easter_buy_ingredient: function(is_skinned) {
						if (is_skinned === true) {
							var l10n = HelperEaster.getSkinl10n();
							return l10n.player_hints.settings.easter_buy_ingredient;
						}
					},
					...
					easter_collect: function(is_skinned) {
						if (is_skinned === true) {
							var l10n = HelperEaster.getSkinl10n();
							return l10n.player_hints.settings.easter_collect;
						}
					},
					...
					easter_buy_recipe: function(is_skinned) {
						if (is_skinned === true) {
							var l10n = HelperEaster.getSkinl10n();
							return l10n.player_hints.settings.easter_buy_recipe;
						}
					},
