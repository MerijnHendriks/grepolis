...
(function (controllers, collections, models, settings) {
	...
	var type = windows.GOLD_TRADE_INTERSTITIAL;
	...
	settings[type] = function (props) {
		...
		return us.extend({
			...
			tabs: [
				...
				{type: tabs.INDEX, title: l10n.tabs[0], content_view_constructor: controllers.GoldTradeInterstitialController, hidden: true}
			],
			max_instances: 1,
			activepagenr: 0,
