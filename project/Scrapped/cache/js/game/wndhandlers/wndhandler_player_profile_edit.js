(function() {
	...
	WndHandlerPlayerProfileEdit.prototype.onInit = function(title, UIopts){
		this.wnd.requestContentGet('player', 'get_profile_html', {inside_edit_profile: true});
	...
	WndHandlerPlayerProfileEdit.prototype.profilePreview = function() {
		...
		this.wnd.ajaxRequestPost('player_profile', 'profile_preview', {'profile_text':text}, function(window, data) {
	...
	WndHandlerPlayerProfileEdit.prototype.profileEdit = function() {
		...
		this.wnd.ajaxRequestPost('player_profile', 'profile_edit', {'profile_text':text}, function(window, data) {
			root.find('#profile_preview').html(data.profile_text);
		});
	};
	...
	WndHandlerPlayerProfileEdit.prototype.changeDefaultVisibility = function(visibility_new) {
		this.wnd.requestContentPost('player_profile', 'set_default_award_visibility', {default_visibility: $(visibility_new).val()});
	};
	...
	WndHandlerPlayerProfileEdit.prototype.changeWorld = function(select) {
		...
		this.wnd.requestContentGet('player_profile', 'award_visibility', {active_world: world_id});
	};
