...
(function() {
	...
	var SubWindowCampaignOverallRewardsView = BaseView.extend({
	...
	window.GameViews.SubWindowCampaignOverallRewardsView = SubWindowCampaignOverallRewardsView;
}());
