...
(function($) {
	...
	$.fn.color_selector = function (params) {
		...
		var _self = this, $el = $(this), $tpl, color_value;
		...
		function chooseColor(event) {
			...
			_self.saved_style = {border: event.target.style.border, width: event.target.style.width, height: event.target.style.height};
