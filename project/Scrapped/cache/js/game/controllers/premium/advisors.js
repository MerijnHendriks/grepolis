...
(function() {
	...
	var PremiumAdvisorsController = TabController.extend({
		...
		getAdvisorAdvantages : function(advisor_id) {
			var advantages = {
				curator : [
					{icon : 'curator_queue', caption : this.getAdvisorFeatureText('curator', 'curator_queue'), caption_size : 'big'},
					{icon : 'overviews', caption : this.getAdvisorFeatureText('curator', 'overviews'), caption_size : 'big'}
				],
				trader : [
					{icon : 'resources', caption : this.getAdvisorFeatureText('trader', 'resources'), caption_size : 'big'}
				],
				priest : [
					{icon : 'favor', caption : this.getAdvisorFeatureText('priest', 'favor'), caption_size : 'big'},
					{icon : 'mythical_units_strength', caption : this.getAdvisorFeatureText('priest', 'mythical_units_strength'), caption_size : 'big'}
				],
				commander : [
					{icon : 'ground_units_strength', caption : this.getAdvisorFeatureText('commander', 'ground_units_strength'), caption_size : 'big'}
				],
				captain : [
					{icon : 'naval_units_strength', caption : this.getAdvisorFeatureText('captain', 'naval_units_strength'), caption_size : 'big'},
					{icon : 'trade_speed', caption : this.getAdvisorFeatureText('captain', 'trade_speed'), caption_size : 'big'},
					{icon : 'attack_planner', caption : this.getAdvisorFeatureText('captain', 'attack_planner'), caption_size : 'small'},
					{icon : 'farm_town_overview', caption : this.getAdvisorFeatureText('captain', 'farm_town_overview'), caption_size : 'small'}
				]
			};
