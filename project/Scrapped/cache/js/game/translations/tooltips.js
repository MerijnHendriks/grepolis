...
(function() {
	...
	DM.loadData({
		l10n: {
			tooltips : {
				wood : _("Wood"), stone : _("Stone"), iron : _("Silver coins"), population : _("Food"), time : _("Time"),
				build_costs : _("Upgrade costs"), build_time : _("Upgrade time"), max_level_reached : _("%1 has reached the maximum upgrade level."),
				requirements : _("Required:"), not_enough_population : _("Not enough farm spaces."),
				too_small_storage : _("Your warehouse is too small."), not_enough_resources : _("Not enough resources."),
				enough_resources_in : _("Enough resources: %1."), full_queue : _("No further orders possible."),
				...
				next_shield_toggle:  function (date) {
					return s(_("Shield activates at:<br />%1"), date);
				}
			}
		}
	});
