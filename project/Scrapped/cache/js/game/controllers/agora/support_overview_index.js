...
(function() {
	...
	var SupportOverviewController = GameControllers.TabController.extend({
		...
		getSortDropdownOptions : function() {
			...
			return [
				{value : 'origin_town_name', name : l10n.origin_town_name},
				{value : 'destination_town_name', name : l10n.destination_town_name},
				{value : 'player_name', name : l10n.player_name},
				{value : 'troop_count', name : l10n.troop_count}
			];
		},
		...
		onConfirmReturnAllUnits : function () {
            GrepoApiHelper.execute('Units', 'sendBackAllUnitsByTown', {town_id: this.getSelectedTownId()}, function (data) {
                this.closeWindow();
            }.bind(this));
		},
