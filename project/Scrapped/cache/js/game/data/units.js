    ...
    var GameDataUnits = {
        ...
        hasTransportUnits: function (unit_ids) {
            return Object.keys(unit_ids).some(
                function (type) { return GameData.units[type].capacity && unit_ids[type] > 0; }
            );
        },
         ...
         * @param {Boolean|null} to_farm_town
         *
         * @returns {integer}
         */
        getSlowestRuntime: function (chosen_units, runtimes, hero, to_farm_town) {
            if (chosen_units.hasOwnProperty(HEROES)) {
            ...
            var setup_time = Math.max(60, 900 / Game.game_speed);
