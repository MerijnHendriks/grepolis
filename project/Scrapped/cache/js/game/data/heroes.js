...
define('data/heroes', function() {
	...
	var GameDataHeroes = {
		...
		getExclusiveHeroCount : function() {
			var count = 0, data_heroes = GameData.heroes, hero_id;
		...
		getSettingsForHeroInjuredProgressbar : function(hero) {
			...
			return {
				caption : l10n.healthy, clear_timer_if_zero : true, show_caption_if_zero : true,
				value : hero.getHealingTimeLeft(), max : hero.getHealingTime(), liveprogress : true,
