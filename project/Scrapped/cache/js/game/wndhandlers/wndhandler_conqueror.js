...
WndHandlerConqueror.prototype.onInit = function(title, UIopts, command_id, other_town_id) {
	...
	this.wnd.requestContentGet('command_info', 'conquest_info', {'command_id': this.command_id});
	return true;
};
...
WndHandlerConqueror.prototype.showTroops = function() {
	...
	this.wnd.requestContentGet('command_info', 'conquest_movements', {'town': this.other_town_id});
};

WndHandlerConqueror.prototype.publish = function() {
	var that = this;
	// send ajax request
	this.wnd.ajaxRequestPost('conquest_info', 'publish', {command_id: this.command_id}, function (window, data) {
		if (data.public_id) {
...
WndHandlerConqueror.prototype.unpublish = function() {
	var that = this;
	// send ajax request
	this.wnd.ajaxRequestPost('conquest_info', 'unpublish', {command_id: this.command_id}, function (window, data) {
