...
(function(controllers) {
	...
	controllers.LayoutMainController = controllers.BaseController.extend({
		...
		getUnitsQueueControllerObject : function(tooltip_position, $el, building_type, cm_context) {
			cm_context = cm_context || {main : 'units_queue_old', sub : 'index'};
		...
		getController : function(name) {
			var controllers = this.sub_controllers, i, l = controllers.length;
		...
		removeController : function(name) {
			var controllers = this.sub_controllers, l = controllers.length;
		...
		initializeCityOverview : function() {
			...
			this.sub_controllers.push({name : 'city_overview', controller : controller.renderPage()});
		},
		...
		initializeEnvironmentAnimations : function() {
			...
			this.sub_controllers.push({name : 'environment_animations', controller : controller.renderPage()});
		},
		...
		initializeGameEventsItems : function() {
			...
			if (this.models.mermaid && this.models.mermaid.getTimeLeft() > 0) {
				...
				this.sub_controllers.push({name : 'game_events_items', controller : controller.renderPage()});
			}
			...
			if (this.collections.benefits.getFirstRunningBenefitOfType(BenefitTypes.TOWN_OVERLAY)) {
                ...
                this.sub_controllers.push({name: windows.TOWN_OVERLAY, controller: town_overlay_controller.renderPage()});
			}
		},
		...
		initializeConstructionQueue : function() {
			...
			this.sub_controllers.push({name : 'construction_queue_container', controller : controller.renderPage()});
		},
		...
		initializeCityConstructionOverlay : function() {
			...
			this.sub_controllers.push({name : 'city_construction_overlay', controller : controller.renderPage()});
		},
		initializeResourcesBar : function() {
			...
			this.sub_controllers.push({name : 'resources_bar', controller : controller.renderPage()});
		},
		...
		initializeQuickBar : function() {
			...
			this.sub_controllers.push({name : 'quickbar', controller : controller.renderPage()});
		},
		...
		initializeTownNameArea : function() {
			...
			this.sub_controllers.push({name : 'town_name_area', controller : controller.renderPage()});
		},
		...
		initializeToolbarActivities : function() {
			...
			this.sub_controllers.push({name : 'toolbar_activities', controller : controller.renderPage()});
		},
		...
		initializeServerTime : function() {
			...
			this.sub_controllers.push({name : 'server_time', controller : controller.renderPage()});
		},
		...
		initializeBullEyeArea : function() {
			...
			this.sub_controllers.push({name : 'bull_eye_area', controller : controller.renderPage()});
		},
		...
		initializeGrepoScore : function() {
			...
			this.sub_controllers.push({name : 'grepo_score', controller : controller.renderPage()});
		},
		...
		initializeInventoryButton : function() {
			...
			this.sub_controllers.push({name : 'inventory_button', controller : controller.renderPage()});
		},
		...
		initializeNotepadButton : function() {
			...
			this.sub_controllers.push({name : 'notepad_button', controller : controller.renderPage()});
		},
		...
		initializePremiumButton : function() {
			...
			this.sub_controllers.push({name : 'premium_button', controller : controller.renderPage()});
		},
		...
		initializeHeroesOverview : function() {
			...
			this.sub_controllers.push({name : 'heroes_overview', controller : controller.renderPage()});
		},
		...
		initializeAdvisors : function() {
			...
			this.sub_controllers.push({name : 'advisors', controller : controller.renderPage()});
		},
		...
		initializePremiumFeatures : function() {
			...
			this.sub_controllers.push({name : 'premium_features_handler', controller : controller.renderPage()});
		},
		...
		initializeMainMenu : function() {
			...
			this.sub_controllers.push({name : 'main_menu', controller : controller.renderPage()});
		},
		...
		initializeConfigButtons : function() {
			...
			this.sub_controllers.push({name : 'config_button', controller : controller.renderPage()});
		},
		...
		initializeGods : function() {
			...
			this.sub_controllers.push({name : 'gods', controller : controller.renderPage()});
		},
		...
		initializeCoins : function() {
			...
			this.sub_controllers.push({name : 'coins', controller : controller.renderPage()});
		},
		...
		initializeBattlepoints : function() {
			...
			this.sub_controllers.push({name : 'battlepoints', controller : controller.renderPage()});
		},
		...
		initializePremium : function() {
			...
			this.sub_controllers.push({name : 'premium_area', controller : controller.renderPage()});
		},
		...
		initializeUnits : function() {
			...
			this.sub_controllers.push({name : 'units', controller : controller.renderPage()});
		},
		...
		initializeUnitsTime : function() {
			...
			this.sub_controllers.push({name : 'units_time', controller : controller.renderPage()});
		},
		...
		initializeGodsSpells : function() {
			...
			this.sub_controllers.push({name : 'gods_spells', controller : controller.renderPage()});
		},
		...
		initializeInfoPage : function() {
			...
			this.sub_controllers.push({name : 'infopage', controller : controller.renderPage()});
		},

		initializeSurvey : function() {
			var SurveyIconController = require('features/surveys/controllers/survey_icon');
			...
			var controller = new SurveyIconController({
				...
				cm_context : this.getContext('survey')
			});


			this.sub_controllers.push({name : 'survey', controller : controller});
		},
		...
		initializeHightlights: function() {
			...
			this.sub_controllers.push({name: 'highlights', controller: controller});
		},
		...
		initializeSkipTutorial: function() {
			...
			this.sub_controllers.push({name: 'skip_tutorial', controller: controller});
		},
