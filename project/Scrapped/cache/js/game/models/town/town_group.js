...
define('models/town/town_group', function() {
	...
	TownGroup.removeTown = function(town_id) {
		this.execute('removeTown', {id: this.getId(), town_id : town_id});
	};
	...
	TownGroup.setActive = function(callback) {
		this.execute('setActive', {id: this.getId()}, callback);
	};
	...
	TownGroup.addTown = function(town_id) {
		this.execute('addTown', {id: this.getId(), town_id: town_id});
	};
	...
	TownGroup.toggleCollapsed = function() {
		this.execute('toggleCollapsed', {id: this.getId()});
	};
