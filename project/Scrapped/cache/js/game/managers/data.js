var DataManager = function() {
    ...
    var saveData = function(data_obj) {
		var i, l = data_types.length, data_type, category, data;
    ...
    var Module = {
		get : function(type, category, name) {
			...
			if (!bunch) {
				return {error : "'" + type + "' '" + category + "-" + name + " doesn't exist. Please check settings.js for this window, and check if the correct action is called, or/and whether template file is not empty."};
			}
