...
define('features/runtime_info/views/runtime_info', function(require) {
	...
	return Views.BaseView.extend({
		...
		registerTooltipsForModifiers: function() {
			...
			this.$el.find('.modifier .unit_movement_boost').tooltip(TooltipFactory.getPowerTooltipWithDefaultSettings(RUNTIME_MODIFIER.UNIT_MOVEMENT, { percent: 30, lifetime: 1800, level : 1 }));
