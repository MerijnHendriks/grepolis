...
(function() {
	...
	WindowsQueueManager.prototype.initializeOpeningWindows = function() {
		var _self = this, wnd, windows_queue = [].concat(this.getQueue()), i, l = windows_queue.length, queued_window_found = false;
		var virtual_queue = [];
	...
	WindowsQueueManager.prototype._addWindow = function(data, queued, force_queueing) {
		...
		settings = (typeof data.type === 'string') ? WF.getSettings(data.type) : { max_instances: 1 };
