/*globals window, GameDataPowers, GameData, us, GrepolisModel  */
...
(function() {
	...
	var CastedPowers = GrepolisModel.extend({
		...
		getCssPowerIdWithLevel : function() {
			return GameDataPowers.getCssPowerIdWithLevel(this.getCssPowerId(), this.getLevel(), this.getSkin(), this.getPowerId());
		},
		...
		getLevel : function() {
			...
			return this.hasConfiguration() ? configuration.level : false;
		},

		getSkin : function() {
			var configuration = this.getConfiguration();
			return this.hasConfiguration() ? configuration.type : '';
		},
