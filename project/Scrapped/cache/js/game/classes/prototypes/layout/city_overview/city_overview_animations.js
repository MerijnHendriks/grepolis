...
(function() {
	...
	var configuration = [{
		...
		check_args : [['barracks', 'docks', 'farm', 'main', 'stoner', 'temple']],
		getter : 'getConstructionGuyAnimationClasses',
		getter_args : [['barracks', 'docks', 'farm', 'main', 'stoner', 'temple']]
	}, {
	...
	CityOverviewAnimations.prototype.getConstructionGuyAnimationClasses = function(buildings) {
		var building_id, classes = [], class_name, level, image_level,
			buildings_orders = this.building_orders_collection;
