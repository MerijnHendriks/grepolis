	...
	DM.loadData({
		"l10n": {
			"premium" : {
				...
				extend_power : {
					confirmation : {
						window_title : _("Extend Divine Power"),
						question : function(cost) {
							return s(ngettext("Are you sure that you want to extend this divine power for %1 gold?", "Are you sure that you want to extend this divine power for %1 gold?", cost), cost);
						}
					}
				},
