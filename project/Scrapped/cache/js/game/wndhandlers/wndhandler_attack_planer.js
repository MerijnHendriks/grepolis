/*global AttackPlanner, WndHandlerDefault, Tracking, MM, hOpenWindow, GPWindowMgr, CM, InfoWindowFactory */
...
(function() {
	...
	WndHandlerAttackPlaner.prototype.showAttack = function(attack_id) {
		this.wnd.requestContentGet(this.controller, 'attacks', {attack_id : attack_id});
	};
