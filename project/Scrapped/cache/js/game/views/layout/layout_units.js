/*global us, BarracksWindowFactory, BarracksWindowFactory, TooltipFactory, GameDataHeroes, GameDataUnits */
		...
		renderUnits: function() {
			...
			for (unit_id in units) {
				if (units.hasOwnProperty(unit_id)) {
					...
					$unit.tooltip(TooltipFactory.getUnitCard(unit_id), {}, false);
				}
			}
