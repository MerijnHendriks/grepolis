...
(function() {
	...
	BrewTable.prototype.getFreeSpotPosition = function() {
		var brew_table = this.brew_table, i, l = brew_table.length;
	...
	BrewTable.prototype.getIngredientsAmount = function(ingredient_type) {
		var ingredient, brew_table = this.brew_table, i, l = brew_table.length, amount = 0;
	...
	BrewTable.prototype.getIngredientTypes = function() {
		var types = [], ingredient, brew_table = this.brew_table, i, l = brew_table.length;
