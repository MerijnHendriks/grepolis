define('models/reward_item', function(require) {
	...
	RewardItem.use = function(callbacks, event_id) {
		return this.execute('execute', {reward_id : this.getId() || this.getRewardId(), 'event_id' : event_id}, callbacks);
	};
	...
	RewardItem.trash = function(callbacks, event_id) {
		return this.execute('trash', {reward_id : this.getId() || this.getRewardId(), 'event_id' : event_id}, callbacks);
	};
	...
	RewardItem.stash = function(callbacks, event_id) {
		return this.execute('stash', {reward_id : this.getId() || this.getRewardId(), 'event_id' : event_id}, callbacks);
	};
