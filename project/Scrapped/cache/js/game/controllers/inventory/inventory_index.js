...
(function () {
	...
	GroupedSlotModel.prototype = {
		getType :  function() { return this.inventory_item.getType(); },
		getId :    function() { return this.inventory_item.getId(); },
		getLevel : function() {	return this.inventory_item.getLevel(); },
		utilize :  function(cb) { return this.inventory_item.utilize(cb);},
		trash :    function() { return this.inventory_item.trash(); },
		getName :     function() { return this.inventory_item.name(); },

		getProperties : function() { return this.inventory_item.getProperties(); },

		getCount:  function() { return this.count; },
		increaseCount: function() { this.count += 1; },
		getRealItem: function() { return this.inventory_item; }
};
	...
	var InventoryController = Controller.extend({
		...
		getGroupedPremiumItems : function() {
			...
			var grouped = us.reduce(items, function(result, item) {
				...
				result[group_id] = result[group_id] || {item : item, count : 0};
