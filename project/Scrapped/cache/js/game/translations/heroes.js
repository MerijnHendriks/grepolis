		...
		l10n: {
			heroes: {
				...
				council: {
					info: {
						title: _('Recruiting'),
						description: _('Once a day you will be offered two new, randomly selected heroes that you can recruit. It will however always be one Hero of War and one Hero of Wisdom.'),
