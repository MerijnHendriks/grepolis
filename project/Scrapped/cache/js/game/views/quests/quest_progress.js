...
(function() {
	...
	var QuestProgress = Controller.extend({
		...
		renderInfo: function () {
			var l10n = this.l10n, $el = this.$el, model = this.model,
		...
		initializeComponents: function () {
			var _self = this, l10n = this.l10n, $el = this.$el,
				model = this.model, rewards = model.get('rewards'), i, l = rewards.length, reward,
				$reward_icon;
