...
(function() {
	...
	WndHandlerConquest.prototype.onRcvData = function(data){
		...
		if (movements){
			...
			while (i--){
				...
				$command_countdown.bind('finish', function() {
					that.wnd.requestContentGet('conquest_info', 'getinfo', {'id': that.currenttownId});
				});
			}
		}
	};
	...
	WndHandlerConquest.prototype.onMessage = function(msgID, p1){
		...
		this.wnd.requestContentGet('conquest_info', 'getinfo', {'id': p1});
	};
