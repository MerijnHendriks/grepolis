...
(function() {
	...
	WndHandlerPremium.prototype.onInit = function(title, UIopts) {
		...
		if (sub_content === 'mentoring') {
			...
			if (!UIopts.noInitRequest) {
				...
				this.wnd.requestContentGet('premium_features', sub_content, {'source': source}, callback);
			}
		}
	...
	WndHandlerPremium.prototype.premiumFeature = function(feature) {
		...
		this.wnd.ajaxRequestGet('premium_features', 'premium_feature', {feature_type: feature}, function(window, data) {
	...
	WndHandlerPremium.prototype.showPremiumFeature = function(feature) {
		var node, fl = $("#featurelist li"), root = this.wnd.getJQElement();
